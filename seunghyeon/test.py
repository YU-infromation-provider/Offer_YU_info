...
for a in range(3):
    ...
    for t in title:
        ...
        dic["title"]=t.get_text()[1:-1]
        href=t.attrs['href'] #href태그 내용 가져오기
        dic["url"]="https://www.yu.ac.kr/main/intro/yu-news.do"+str(href)
...
print(json_file)
file_path="Offer_YU_info/seunghyeon/title.json"
with open(file_path,'w') as outfile:
    json.dump(json_file,outfile,ensure_ascii=False,indent="\t")